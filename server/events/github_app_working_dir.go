...
func (g *GithubAppWorkingDir) Clone(log logging.SimpleLogging, headRepo models.Repo, p models.PullRequest, workspace string, projectName string) (string, bool, error) {
	...
	return g.WorkingDir.Clone(log, headRepo, p, workspace, projectName)
}
