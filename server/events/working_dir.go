...
type WorkingDir interface {
	...
	Clone(log logging.SimpleLogging, headRepo models.Repo, p models.PullRequest, workspace string, projectName string) (string, bool, error)
	// GetWorkingDir returns the path to the workspace for this repo and pull.
	// If workspace does not exist on disk, error will be of type os.IsNotExist.
	GetWorkingDir(r models.Repo, p models.PullRequest, workspace string, projectName string) (string, error)
	...
	DeleteForWorkspace(r models.Repo, p models.PullRequest, workspace string, projectName string) error
}
...
func (w *FileWorkspace) Clone(
	...
	workspace string,
	projectName string) (string, bool, error) {
	cloneDir := w.cloneDir(p.BaseRepo, p, workspace, projectName)
...
// GetWorkingDir returns the path to the workspace for this repo and pull.
func (w *FileWorkspace) GetWorkingDir(r models.Repo, p models.PullRequest, workspace string, projectName string) (string, error) {
	repoDir := w.cloneDir(r, p, workspace, projectName)
...
func (w *FileWorkspace) DeleteForWorkspace(r models.Repo, p models.PullRequest, workspace string, projectName string) error {
	return os.RemoveAll(w.cloneDir(r, p, workspace, projectName))
}
...
func (w *FileWorkspace) cloneDir(r models.Repo, p models.PullRequest, workspace string, projectName string) string {
	return filepath.Join(w.repoPullDir(r, p), workspace, projectName)
}
